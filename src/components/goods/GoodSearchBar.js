...
class GoodSearchBar extends Component {
  ...
  handleInput(event) {
    ...
    this.props.dispatch(searchGoods(value, this.state.searchType, this.state.sortType));
  }
  ...
  handleSearchChange(event) {
    ...
    this.props.dispatch(searchGoods(this.state.searchText, value, this.state.sortType));
  }
  ...
  handleSortChange(event) {
    ...
    this.props.dispatch(searchGoods(this.state.searchText, this.state.searchType, value));
  }
