...
const programOccurrence = require('./programOccurrence');
...
for (const characteristic of [...client, ...serviceProvider, ...service, ...serviceOccurrence, ...programOccurrence, ...program, ...appointment, ...general]) {
