...
var RdfXmlParser = require('rdfxml-streaming-parser').RdfXmlParser;
/**
...
var RDFXmlParser = /*#__PURE__*/function (_ContentParser) {
  _inherits(RDFXmlParser, _ContentParser);

  var _super = _createSuper(RDFXmlParser);

  /**
   * @param {Object} config is an object containing the parser configuration.
   */
  function RDFXmlParser(config) {
    var _this;

    _classCallCheck(this, RDFXmlParser);

    _this = _super.call(this, config);
    _this.parser = new RdfXmlParser(_this.config);
    return _this;
  }
  /**
   * @inheritDoc
