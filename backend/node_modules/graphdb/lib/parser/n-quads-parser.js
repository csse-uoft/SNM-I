...
var NQuadsParser = /*#__PURE__*/function (_ContentParser) {
  _inherits(NQuadsParser, _ContentParser);

  var _super = _createSuper(NQuadsParser);

  /**
   * @param {Object} config is an object containing the parser configuration.
   */
  function NQuadsParser(config) {
    var _this;
