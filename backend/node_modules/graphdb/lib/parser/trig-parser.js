...
var TriGParser = /*#__PURE__*/function (_ContentParser) {
  _inherits(TriGParser, _ContentParser);

  var _super = _createSuper(TriGParser);

  /**
   * @param {Object} config is an object containing the parser configuration.
   */
  function TriGParser(config) {
    var _this;

    _classCallCheck(this, TriGParser);

    _this = _super.call(this, config);
    _this.parser = new Parser({
      format: _this.getSupportedType()
    });
    return _this;
  }
  /**
