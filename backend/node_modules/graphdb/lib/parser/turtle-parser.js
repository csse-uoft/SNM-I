...
var TurtleParser = /*#__PURE__*/function (_ContentParser) {
  _inherits(TurtleParser, _ContentParser);

  var _super = _createSuper(TurtleParser);
  ...
  function TurtleParser(config) {
    ...
    _classCallCheck(this, TurtleParser);
