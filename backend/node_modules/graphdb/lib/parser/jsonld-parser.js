...
var JsonLdParser = require('jsonld-streaming-parser').JsonLdParser;
/**
...
var JsonLDParser = /*#__PURE__*/function (_ContentParser) {
  _inherits(JsonLDParser, _ContentParser);

  var _super = _createSuper(JsonLDParser);

  /**
   * @param {Object} config is an object containing the parser configuration.
   */
  function JsonLDParser(config) {
    var _this;

    _classCallCheck(this, JsonLDParser);

    _this = _super.call(this, config);
    _this.parser = new JsonLdParser(_this.config);
    return _this;
  }
  /**
   * @inheritDoc
