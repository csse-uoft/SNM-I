...
var NTriplesParser = /*#__PURE__*/function (_ContentParser) {
  _inherits(NTriplesParser, _ContentParser);

  var _super = _createSuper(NTriplesParser);

  /**
   * @param {Object} config is an object containing the parser configuration.
   */
  function NTriplesParser(config) {
    var _this;

    _classCallCheck(this, NTriplesParser);
